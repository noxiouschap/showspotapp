...
import 'package:movie_booking_app1/controllers/calendar_controller.dart';
...
import 'package:movie_booking_app1/screens/seat_selection_screen.dart';
import 'package:movie_booking_app1/utils/custom_calendar.dart';
import 'package:movie_booking_app1/utils/dummy_data.dart';
import 'package:movie_booking_app1/utils/screen_selection_block.dart';
import 'package:movie_booking_app1/widgets/theatre_block.dart';

class ListCinemaScreen extends StatefulWidget {
  final MovieModel model;
  const ListCinemaScreen({super.key, required this.model});
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: BottomAppBar(
          color: const Color.fromARGB(255, 6, 37, 86),
          elevation: 0,
          child: Container(
