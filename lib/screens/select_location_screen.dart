...
import 'package:movie_booking_app1/screens/home_screen.dart';
import 'package:movie_booking_app1/utils/dummy_data.dart';

class SelectionLocationScreen extends StatefulWidget {
  const SelectionLocationScreen({super.key});

  @override
  State<SelectionLocationScreen> createState() =>
      _SelectionLocationScreenState();
}
    ...
    child: GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: Color.fromARGB(200, 6, 37, 86),
