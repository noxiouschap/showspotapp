import 'package:movie_booking_app1/model/ad_slider_model.dart';
import 'package:movie_booking_app1/model/crew_cast_model.dart';
import 'package:movie_booking_app1/model/event_model.dart';
import 'package:movie_booking_app1/model/menu_model.dart';
import 'package:movie_booking_app1/model/movies_model.dart';
import 'package:movie_booking_app1/model/offer_model.dart';
import 'package:movie_booking_app1/model/seat_layout_model.dart';
import 'package:movie_booking_app1/model/theatre_model.dart';
import 'package:movie_booking_app1/utils/constants.dart';
import 'package:movie_booking_app1/utils/mytheme.dart';
...
final seatLayout = SeatLayoutModel(
    ...
    seatTypes: [
      ...
      {"title": "Balcony", "price": 100.0, "status": "Available"},
      {"title": "Classic", "price": 80.0, "status": "Available"},
    ],
    theatreId: 123,
    gap: 2,
    gapColIndex: 5,
